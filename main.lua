...
function displayPlayers()
    ...
    if player1.ai == true then
        love.graphics.print('AI', 90, 90)
    else
        love.graphics.print('Human', 80, 90)
    end
    love.graphics.print('Player 2', 320, 70)
    if player2.ai == true then
        love.graphics.print('AI', 330, 90)
    else
        love.graphics.print('Human', 320, 90)
    end
    love.graphics.printf('Press 1 or 2 to change players', 0, 150, VIRTUAL_WIDTH, 'center')
end